...
#define CMD_AUCTION_INIT "AUCTION_INIT" // AUCTION_INIT <auc_id> <sensor_type> <xpos> <ypos> 
#define CMD_AUCTION_WON  "AUCTION_WON" // AUCTION_WON <auc_id> <robot_id>
#define CMD_AUCTION_BID  "AUCTION_BID" // AUCTION_BID <auc_id> <bid>
#define CMD_AUCTION_COMPLETE "AUCTION_COMPLETE" // AUCTION_COMPLETE <auc_id>
...
#define STATE_CAMPOSE   23

#define STATE_AUCTION_INIT 24
#define STATE_AUCTION_WON 25
#define STATE_AUCTION_BID 26
#define STATE_AUCTION_COMPLETE 27
